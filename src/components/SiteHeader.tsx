  ...
  return (
    <header className="sticky top-0 z-40 w-full">
      <div className="hidden bg-brand-800 text-white sm:block">
        <div className="mx-auto flex max-w-[1600px] items-center justify-between gap-4 px-6 py-2 text-xs sm:text-sm sm:px-10 lg:px-16">
      ...
      <div className="border-b border-border bg-white">
        <div className="mx-auto flex max-w-[1600px] items-center gap-5 px-6 py-4 sm:px-10 lg:px-16 xl:gap-6">
